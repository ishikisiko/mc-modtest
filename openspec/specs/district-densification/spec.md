# District Densification

## Purpose

This spec captures the densification of cultivation town district interiors beyond a single frontage band: layering a secondary back-row depth band on deep districts, dressing residual courtyard negative space as enclosed lived-in 院落 tissue, and lining the central spine with a 坊市 market streetscape so the town reads as layered and inhabited rather than a single street wall fronting empty ground.
