# Cultivation Variant Differentiation

## Purpose

This spec captures how small/medium cultivation town archetypes express deliberately distinct massing forms across their `_v1`/`_v2`/`_v3` variant tiers, so a player sees meaningfully different building shapes between variants rather than RNG-perturbed copies of one template.
